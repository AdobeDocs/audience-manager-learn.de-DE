...
+ Branchennachrichten und -trends {#industry}
   + [Die Zukunft der Datenverwaltung und der sich ändernden Umgebung](https://experienceleague.adobe.com/docs/platform-learn/tutorials/industry/the-future-of-data-management-and-the-changing-environment.html)
   ...
   + [Ausbau Ihres Audience Center of Excellence](https://experienceleague.adobe.com/docs/platform-learn/tutorials/industry/evolving-your-audience-center-of-excellence.html)
...
+ Einrichtung und Admin {#setup-and-admin}
   + Datenquellen {#data-sources}
      ...
      + [Geräteübergreifende Datenquelle erstellen und authentifizieren](setup-and-admin/data-sources/creating-a-cross-device-data-source-and-authenticating.md)
...
+ Web-Implementierung {#web-implementation}
   ...
   + SSF (serverseitige Weiterleitung) {#ssf}
      ...
      + [Migrieren der AAM Ihrer Site von der clientseitigen DIL zur serverseitigen Weiterleitung](web-implementation/ssf/migrating-your-site-implementation-from-client-side-dil-to-server-side-forwarding.md)
...
+ Audience Marketplace {#audience-marketplace}
   + Daten kaufen {#buying-data}
      + [Berichterstellung zur Datennutzung von Zweit- und Drittanbietern im Audience Marketplace auf Segmentebene](audience-marketplace/buying-data/reporting-2nd-and-3rd-party-data-usage-in-the-audience-marketplace-at-the-segment-level.md)
      + [Massenupload der Datennutzung in Audience Marketplace](audience-marketplace/buying-data/bulk-uploading-data-usage-into-the-audience-marketplace.md)
...
+ Erstellen und Verwalten von Zielgruppen {#build-and-manage-audiences}
   + Data Explorer {#data-explorer}
      ...
      + [Verwenden Sie Data Explorer, um die Erstellung von Eigenschaften für integrierte Daten zu validieren.](build-and-manage-audiences/data-explorer/using-data-explorer-to-validate-trait-creation-for-your-onboarded-data.md)
   ...
   + Eigenschaften und Segmente {#traits-and-segments}
      + [Planen der Eigenschaftserstellung aus Analytics-Daten](build-and-manage-audiences/traits-and-segments/planning-trait-creation-from-analytics-data.md)
      ...
      + [Zahlen im Eigenschaftsdiagramm verstehen](build-and-manage-audiences/traits-and-segments/understanding-numbers-in-the-trait-graph.md)
   ...
   + Algorithmische Modelle {#algorithmic-models}
      + [Vorhersagekräftige Zielgruppen](build-and-manage-audiences/algorithmic-models/understanding-predictive-audiences.md)
      + [Konfigurieren von und Berichten für [!UICONTROL Predictive Audiences]](build-and-manage-audiences/algorithmic-models/configure-and-report-on-predictive-audiences.md)
   ...
   + Profilzusammenführung {#profile-merge}
      ...
      + [Auswirkungen von Profilzusammenführungsrichtlinien-Verbesserungen auf Segmentierung, Aktivierung und Reporting](build-and-manage-audiences/profile-merge/how-profile-merge-rule-enhancements-impact-segmentation-activation-and-reporting.md)
      ...
      + [Geräteübergreifende Metriken in Audience Manager verstehen](build-and-manage-audiences/profile-merge/understanding-cross-device-metrics-in-audience-manager.md)
...
+ Sonstige Integrationen {#other-integrations}
   + Integrieren mit Real-time Customer Data Platform {#integrating-with-rtcdp}
      ...
      + [Signale in der Echtzeit-Kundendatenplattform verstehen](other-integrations/integrating-with-rtcdp/rtcdp-signals-for-aam-users.md)
